...
export const initialPendingEvents: GsoEvent[] = [
  {
    id: "1",
  ...
  },
  {
    ...
    startTime: "3:00 PM",
    endTime: "9:00 PM",
    itemsEquipment: "Stage setup, professional sound system, lighting equipment, generator, security barriers",
    letterContent:
...
export const initialApprovedEvents: GsoEvent[] = [
  {
    id: "5",
