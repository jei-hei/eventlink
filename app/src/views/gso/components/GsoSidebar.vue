    ...
    >
      <div class="flex items-center justify-between border-b border-white/10 px-4 py-3 sm:px-5 sm:py-3.5">
        <div class="flex min-w-0 items-center gap-2.5">
          ...
          >
            <span class="text-xs font-bold text-white">GS</span>
          </div>
          <div>
            <div class="text-white text-sm font-bold leading-tight">EventLink</div>
            <div class="text-[#4ADE80] text-[10px] font-semibold uppercase tracking-wider">GSO Dashboard</div>
          </div>
        </div>
        <button
          type="button"
      ...
      <PortalSidebarFooter portal-label="GSO" />
    </aside>
  </div>
</template>
