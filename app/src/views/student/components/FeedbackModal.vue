...
async function handleSubmit() {
  ...
  if (props.requireFeedbackAccessCode && !accessCode.value.trim()) {
  ...
  try {
    await submitEventFeedback({
      ...
      accessCode: props.requireFeedbackAccessCode ? accessCode.value.trim() : undefined,
    });
    emit("submitted");
    close();
  } catch (e) {
  ...
  >
    <div class="bg-white rounded-lg shadow-2xl max-w-md w-full max-h-[90vh] flex flex-col" @click.stop>
      ...
      <div class="p-6 space-y-5 overflow-y-auto">
        ...
        <div v-if="requireFeedbackAccessCode" class="space-y-2">
