...
const navItems = [
  { label: "Dashboard", to: "/executive-officer/analytics", name: "eo-analytics", icon: BarChart2 },
  { label: "Event Management", to: "/executive-officer", name: "eo-dashboard", icon: LayoutDashboard },
