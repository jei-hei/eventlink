...
const navItems = [
  { label: "Dashboard", to: "/dean/analytics", name: "dean-analytics", icon: BarChart2 },
  { label: "Event Management", to: "/dean", name: "dean-dashboard", icon: LayoutDashboard },
  { label: "Event Monitoring", to: "/dean/monitoring", name: "dean-monitoring", icon: Radar },
  { label: "Profile", to: "/dean/profile", name: "dean-profile", icon: UserCircle },
] as const;
...
<template>
  <div class="portal-sidebar-slot">
    ...
    >
      <div class="flex items-center justify-between border-b border-white/10 px-4 py-3 sm:px-5 sm:py-3.5">
        <div class="flex min-w-0 items-center gap-2.5">
          ...
          <div>
            ...
            <div class="text-[#4ADE80] text-[10px] font-semibold uppercase tracking-wider">Dean Portal - ICT</div>
          </div>
        </div>
        <button
          type="button"
      ...
      <PortalSidebarFooter portal-label="Dean" />
    </aside>
  </div>
</template>
