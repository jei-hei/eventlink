...
const navItems = [
  { label: "Dashboard", to: "/student-officer/analytics", name: "officer-analytics", icon: BarChart2 },
  { label: "Event Management", to: "/student-officer", name: "officer-dashboard", icon: LayoutDashboard },
...
<template>
  <div class="portal-sidebar-slot">
    ...
    >
      <div class="flex items-center justify-between border-b border-white/10 px-4 py-3 sm:px-5 sm:py-3.5">
        <div class="flex min-w-0 items-center gap-2.5">
          ...
          <div>
            ...
            <div class="text-[#4ADE80] text-[10px] font-semibold uppercase tracking-wider">Student Portal</div>
          </div>
        </div>
        <button
          type="button"
      ...
      <PortalSidebarFooter portal-label="Student Officer" />
    </aside>
  </div>
</template>
